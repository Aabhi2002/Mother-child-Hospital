          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center animate-fade-in">
              <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6 font-heading">
                Our Story: 25+ Years of Care
              </h1>
              <p className="text-xl text-muted-foreground leading-relaxed">
                What began as a vision has grown into a trusted healthcare institution,
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                <p>
                  Founded over 25 years ago by Dr. V Rakesh and Dr. V Hema, Curewell Hospital began with a simple mission:
                  to provide safe, compassionate maternity care to women in our community. In an era when healthcare
                  options were limited, Dr. V Rakesh and Dr. V Hema envisioned a place where every mother would feel supported,
